...
它不是演示 Demo，而是一个作者本人**每天都在用的桌面助手**，经多年迭代（v4.97）+ 脱敏后开源。
...
<img src="https://sfile.chatglm.cn/workspace/image/57/57d529429a.png" alt="AgentDesktop 整体架构：用户交互层 → Agent 核心 → 多模型路由 → 权限引擎 → 工具执行层 → 本地数据层" width="860">
